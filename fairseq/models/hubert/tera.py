...
@register_model("tera", dataclass=HubertConfig)
class TeraModel(BaseFairseqModel):
    def __init__(
        self,
        cfg: HubertConfig,
    ...
    def get_mfcc_feats(self, xs, ref_len=None):
    ...
    def forward(
        ...
        features = self.forward_features(source) # [batch, 512, time]
        ...
        unmasked_features = features.clone() # [batch, time, 512]
